...
class _GridControlPageState extends State<GridControlPage>
                ...
                children: [
                  ...
                  if (_dbTelemetry.isRunning && !_gpsFix) ...[
                    ...
                    _buildWarningChip(
                      Icons.satellite_alt,
                      _satelliteCount > 0
                          ? 'GPS terdeteksi, menunggu fix (${_satelliteCount}sat)'
  ...
  /// Cell telemetri super compact — label di atas, value di bawah
      ...
      child: Column(
        ...
        children: [
          _actionBtn(
            ...
            canExecuteRoute,
            const Color(0xFF10B981),
            canExecuteRoute ? _executeRoute : null,
          ),
          const SizedBox(height: 6),
          _actionBtn(
            'STOP',
