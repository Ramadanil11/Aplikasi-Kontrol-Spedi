...
class WebSocketService {
  ...
  Future<void> connect() async {
    ...
    // ✅ LANGSUNG AMBIL TOKEN - TIDAK ADA CEK AUTH YANG BLOCKING!
  ...
  String _extractToken() {
    ...
    debugPrint('[WS] _extractToken() called, token: ${token != null ? "${token.substring(0, 20)}..." : "NULL"}');
    if (token == null || token.isEmpty) {
      throw StateError('Access token tidak tersedia! Login dulu atau token belum di-set.');
    }
    return token;
  }
}
